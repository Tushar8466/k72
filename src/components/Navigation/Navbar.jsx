...
function Navbar() {
    ...
    return (
        <div className='flex fixed top-0 w-full items-start justify-between z-10'>
            <div className='p-2'>
                <svg className='h-full w-full text-white' xmlns="http://www.w3.org/2000/svg" width="103" height="44" viewBox="0 0 103 44">
            ...
            <div
                ...
                className='h-12 relative w-[16vw] bg-black cursor-pointer'>
