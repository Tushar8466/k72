...
function HomeHeroText() {
  return (
    <div className="font-[font1] pt-5 text-center">
      ...
      <div className="text-[10vw] uppercase leading-[8.5vw] flex justify-center items-center">qui<div className="h-[7vw] w-[10vw] rounded-full overflow-hidden -mt-5"><Video /></div>génère</div>
